// Most (if not all) of this code won't work out of the box.
// You need to run it in an ES6 friendly environment.
// I am going to use the ES6 REPL extension for chrome.
